(() => {
  ...
  var utils = {
    ...
    makeline: function(p1, p2) {
      return new Bezier2(p1.x, p1.y, (p1.x + p2.x) / 2, (p1.y + p2.y) / 2, p2.x, p2.y);
    },
    ...
    isLinear: function(points, order) {
      ...
      return aligned.reduce((t2, p) => t2 + abs(p.y), 0) < baselength / 50;
    },
  ...
  // src/types/line2d.js
  var Line2D = class extends Bezier {
    constructor(...coords) {
      if (coords.length === 4) {
        coords = [
  ...
  // src/types/line3d.js
  var Line3D = class extends Bezier {
    constructor(...coords) {
      if (coords.length === 6) {
        coords = [
          { x: coords[0], y: coords[1] },
  ...
  // src/types/bezier22.js
  var Bezier22 = class extends Bezier {
    constructor(...coords) {
      if (coords.length === 6) {
        coords = [
          { x: coords[0], y: coords[1] },
  ...
  // src/types/bezier32.js
  var Bezier32 = class extends Bezier {
    constructor(...coords) {
      if (coords.length === 8) {
        coords = [
          { x: coords[0], y: coords[1] },
  ...
  // src/types/bezier23.js
  var Bezier23 = class extends Bezier {
    constructor(...coords) {
      if (coords.length === 9) {
        coords = [
  ...
  // src/types/bezier33.js
  var Bezier33 = class extends Bezier {
    constructor(...coords) {
      if (coords.length === 12) {
        coords = [
          { x: coords[0], y: coords[1], z: coords[2] },
  ...
  // src/bezier.js
  var { abs: abs2, min, max, cos: cos2, sin: sin2, acos: acos2, sqrt: sqrt2, PI: pi2 } = Math;
  var Bezier2 = class {
    constructor(coords) {
    ...
    static quadraticFromPoints(p1, p2, p3, t2) {
      ...
      const abc = Bezier2.getABC(2, p1, p2, p3, t2);
    ...
    static cubicFromPoints(S, B, E, t2, d1) {
      ...
      const abc = Bezier2.getABC(3, S, B, E, t2);
    ...
    getABC(t2, B) {
      ...
      return Bezier2.getABC(this.order, S, B, E, t2);
    }
    getLUT(steps) {
      this.verify();
      steps = steps || 100;
    ...
    align() {
      let p = this.points;
      return new Bezier2(utils.align(p, { p1: p[0], p2: p[p.length - 1] }));
    }
    curvature(t2) {
    ...
    outline(d1, d2, d3, d4) {
      ...
      if (this._linear) {
        ...
        const segments2 = [ls2, new Bezier2(fline), le2, new Bezier2(bline)];
