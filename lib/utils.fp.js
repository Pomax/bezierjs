...
utils.Tvalues = utilsOO.Tvalues;
utils.Cvalues = utilsOO.Cvalues;
utils.arcfn = utilsOO.arcfn;
utils.between = utilsOO.between;
utils.approximately = utilsOO.approximately;
utils.length = utilsOO.length;
utils.map = utilsOO.map;
utils.lerp = utilsOO.lerp;
utils.pointToString = utilsOO.pointToString;
utils.pointsToString = utilsOO.pointsToString;
utils.copy = utilsOO.copy;
utils.angle = utilsOO.angle;
utils.round = utilsOO.round;
utils.dist = utilsOO.dist;
utils.closest = utilsOO.closest;

utils.abcratio = function(t, n) {
  var tCopy = t;
  return utilsOO.abcratio(tCopy);
};

utils.projectionratio = function(t, n) {
  var tCopy = t;
  return utilsOO.projectionratio(tCopy);
};

utils.lli8 = utilsOO.lli8;
utils.lli4 = utilsOO.lli4;
utils.lli = utilsOO.lli;
...
utils.align = utilsOO.align;
utils.roots = utilsOO.roots;
utils.droots = utilsOO.droots;
utils.inflections = utilsOO.inflections;
utils.bboxoverlap = utilsOO.bboxoverlap;
