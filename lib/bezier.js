...
(function() {
  ...
  Bezier.prototype = {
    ...
    scale: function(d, distanceFn) {
      var order = this.order;
      if(distanceFn && order === 2) {
        return this.raise().scale(d,distanceFn);
      }
      var r1 = distanceFn ? distanceFn(0) : 1;
      var r2 = distanceFn ? distanceFn(1) : 1;
      ...
      [0,1].forEach(function(t) {
        ...
        p.x += d * (t?r2:r1) * v[t].n.x;
        p.y += d * (t?r2:r1) * v[t].n.y;
      }.bind(this));
      ...
      if (!distanceFn) {
        ...
        [0,1].forEach(function(t) {
          ...
          var rc = distanceFn ? distanceFn((t+1)/order) : 1;
    ...
    outline: function(d1, d2, distanceFn) {
      d2 = d2 || d1;
      distanceFn = distanceFn || function(v) {
        return v;
      };
      var reduced = this.reduce(),
          len = reduced.length,
      ...
      function linearDistanceFunction(tlen,alen,slen) {
        return function (v) {
          return utils.map(v,0,1,alen/tlen,(alen+slen)/tlen);
        };
      };
      ...
      reduced.forEach(function(segment) {
        slen = segment.length();
        fcurves.push(segment.scale( d1, linearDistanceFunction(tlen,alen,slen)));
        bcurves.push(segment.scale(-d2, linearDistanceFunction(tlen,alen,slen)));
        alen += slen;
      });
