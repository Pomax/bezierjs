  ...
  Bezier.prototype = {
    ...
    outline: function(d1, d2, d3, d4) {
      ...
      var fs = fcurves[0].points[0],
        ...
        ls = this._makeline(bs, fs),
        le = this._makeline(fe, be),
        segments = [ls]
          .concat(fcurves)
          .concat([le])
          .concat(bcurves),
    ...
    _makeshape: function(forward, back, curveIntersectionThreshold) {
      var bpl = back.points.length;
      var fpl = forward.points.length;
      var start = this._makeline(back.points[bpl - 1], forward.points[0]);
      var end = this._makeline(forward.points[fpl - 1], back.points[0]);
      var shape = {
        startcap: start,
        forward: forward,
        back: back,
