...
const assert = require('chai').use(require('chai-stats')).assert;

// plain and SVG quadratic check
(function testQuadratic () {
  [
    new Bezier(0, 0, 0.5, 1, 1, 0),
...
(function testHigherOrder () {
  ...
  var test_bezier = [0, 1.74, 0.21, 1.67, 0.28, 1.32, 0.28, 0.86];
  var test_line = { p1: { x: -0.56, y: 0.95 }, p2: { x: 0.57, y: 0.95 } };
